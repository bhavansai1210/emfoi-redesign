    ...
    <PageLayout>
      <section className="home-hero">
        <div className="site-width home-hero-grid">
          ...
          <motion.div className="hero-visual" style={reducedMotion ? undefined : { y: heroImageScrollY, rotate: heroImageScrollRotate, scale: heroImageScrollScale }} initial={reducedMotion ? false : { opacity: 0, x: 58, scale: 0.97 }} animate={reducedMotion ? undefined : { opacity: 1, x: 0, scale: 1 }} transition={{ duration: 0.9, delay: 0.12, ease: heroEase }}><div className="hero-image-frame"><img className="hero-image-motion" src="/manus-storage/emfoi-hero-civic-systems_d308c3fa.jpg" alt="Abstract systems and planning objects in an EMFOI signature color palette" /></div><div className="hero-visual-label"><span className="signal-dot" />Software · AI · Staffing</div><div className="hero-corner-note"><span>Scroll to explore</span><ArrowDownRight size={18} /></div></motion.div>
        </div>
