...
function CapabilityDetail({ data }: { data: (typeof capabilityData)[Slug] }) {
  return (
    <PageLayout>
...
export default function Capabilities() {
  ...
  return slug && capabilityData[slug] ? <CapabilityDetail data={capabilityData[slug]} /> : <CapabilityIndex />;
}
