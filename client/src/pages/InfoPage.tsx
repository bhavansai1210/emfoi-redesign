...
function AboutPage() {
  const teamProfileSlots = [
    { number: "01", type: "Leadership", title: "Sai Chaitanya Nandigam", text: "President & Founder. [Bio pending verification of federal UX modernization and design leadership experience].", image: "/manus-storage/emfoi-role-portrait-leadership_1778d07b.jpg", alt: "Sai Chaitanya Nandigam, President & Founder of EMFOI" },
