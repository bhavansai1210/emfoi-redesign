...
const pageSeo = {
  "/government": { title: "Government Technology, AI & Staffing | EMFOI", description: "EMFOI supports federal, state, and local programs with custom software, responsible AI, IT consulting, and healthcare staffing for teaming and delivery needs.", canonicalPath: "/government", breadcrumbs: [{ name: "Government", path: "/government" }] },
...
function HealthcarePage() {
  ...
  return <PageLayout><PageHero variant="data" eyebrow="Healthcare" title="Technology, AI, and staffing with healthcare realities in view." intro="EMFOI supports care organizations and government health programs with custom software, practical AI governance, IT consulting, and healthcare staffing." ><Link href="/contact" className="button button-primary">Discuss a healthcare need <ArrowRight size={16} /></Link></PageHero><section className="site-width care-route-map" aria-label="Healthcare delivery map"><div className="care-route-mark" aria-hidden="true"><i /><i /><i /><i /></div><div><span>01 / OPERATIONS</span><p>Map the care, coordination, and workflow context.</p></div><div><span>02 / DELIVERY</span><p>Connect usable systems, practical governance, and focused support.</p></div><div><span>03 / NEXT ACTION</span><p>Choose the capability that fits the work in front of the team.</p></div></section><section className="paper-section"><div className="site-width healthcare-intro-grid"><div><p className="eyebrow"><span />A focused delivery mix</p><h2>Connect the systems, governance, and people behind care.</h2></div><p className="large-copy">Healthcare work brings operational, technology, and workforce needs into the same conversation. EMFOI offers a focused set of capabilities that can stand alone or work together around the program in front of you.</p></div></section><section className="site-width healthcare-capability-section"><div className="section-split-heading"><div><p className="eyebrow"><span />Explore by need</p><h2>Start with the work that needs support.</h2></div><p>Each capability page explains EMFOI’s current delivery posture in direct, factual terms.</p></div><div className="healthcare-capability-grid">{healthcareCapabilities.map((capability) => <Link key={capability.href} href={capability.href} className="healthcare-capability-card"><span>{capability.number}</span><div><h3>{capability.title}</h3><p>{capability.text}</p></div><ChevronRight size={21} /></Link>)}</div></section><section className="ink-cta-section"><div className="site-width ink-cta-grid"><div><p className="eyebrow eyebrow-light"><span />Healthcare staffing</p><h2>Need qualified clinical or healthcare-IT talent?</h2></div><p>Explore EMFOI’s healthcare staffing capability or begin a focused conversation about your program context.</p><Link href="/capabilities/healthcare-staffing" className="button button-light">Explore healthcare staffing <ArrowRight size={16} /></Link></div></section></PageLayout>;
}

function AboutPage() {
  const teamProfileSlots = [
    { number: "01", type: "Leadership", title: "Direction and accountability", text: "Set the engagement direction, shape the team, and keep the delivery mandate clear.", image: "/manus-storage/emfoi-role-portrait-leadership_1778d07b.jpg", alt: "Editorial portrait representing an EMFOI leadership engagement role" },
    { number: "02", type: "Delivery", title: "Program delivery", text: "Coordinate work across people, systems, and program requirements with a practical operating rhythm.", image: "/manus-storage/emfoi-role-portrait-delivery_54b0d31c.jpg", alt: "Editorial portrait representing an EMFOI program-delivery engagement role" },
    { number: "03", type: "Practice expertise", title: "Focused capability", text: "Bring the right software, governance, staffing, or healthcare capability to the work in front of the program.", image: "/manus-storage/emfoi-role-portrait-practice_d8301bce.jpg", alt: "Editorial portrait representing an EMFOI focused-capability engagement role" },
  ];
  return <PageLayout><PageHero variant="record" eyebrow="About EMFOI" title="A focused partner for work that needs to hold up." intro="EMFOI, Inc. is a Delaware corporation established in 2013 and headquartered in Herndon, Virginia. We deliver custom software, AI development and governance, IT consulting and staffing, and healthcare staffing to government and enterprise clients." /><section className="site-width about-story"><div><p className="eyebrow"><span />Our story</p><h2>Built around delivery, not unnecessary scale.</h2></div><div><p className="large-copy">Over more than a decade, EMFOI has staffed teams on federal programs, delivered IT consultants to enterprise clients through prime vendors, and built its own software product, DoFiling, for legal professionals.</p><p>We believe a credible partner is clear about what it knows, careful about what it claims, and ready to contribute where the work needs it. That perspective guides how we build teams, software, and long-term relationships.</p></div></section><section className="paper-section about-mission-section"><div className="site-width about-mission-grid"><div><p className="eyebrow"><span />Our mission</p><h2>Bring personal service and practical technology together.</h2></div><div><p className="large-copy">EMFOI’s mission is to pair the personal service of a focused technology partner with the reach and capability needed for complex work.</p><p>We aim to make technology easier to understand, more useful to the people who depend on it, and better connected to the goals of the organization or program around it.</p></div></div></section><section className="paper-section values-section"><div className="site-width"><p className="eyebrow"><span />Our core values</p><div className="values-grid"><article><span>01</span><h3>Passionate</h3><p>We bring energy and care to the work of helping organizations move forward.</p></article><article><span>02</span><h3>Respectful</h3><p>We communicate with consideration for clients, colleagues, users, and the realities around the work.</p></article><article><span>03</span><h3>Ownership</h3><p>We take responsibility for our role, our decisions, and the quality of the delivery we support.</p></article><article><span>04</span><h3>Unified</h3><p>We work as one team across disciplines, partners, and program requirements.</p></article></div></div></section><section className="paper-section team-profile-section"><MotionReveal className="site-width"><div className="team-profile-intro"><div><p className="eyebrow"><span />How we organize delivery</p><h2>Direction, delivery, and specialized practice.</h2></div><p>EMFOI brings the appropriate roles together around the work: clear direction, attentive delivery coordination, and the focused capability the program needs.</p></div><p className="team-profile-visual-note">Illustrative role portraits — individual EMFOI biographies are added only with approved information.</p><div className="team-profile-grid">{teamProfileSlots.map((profile) => <article className="team-profile-card" key={profile.number}><figure className="team-profile-portrait"><img src={profile.image} alt={profile.alt} loading="lazy" /></figure><div className="team-profile-mark"><UsersRound size={18} /><span>{profile.number}</span></div><p>{profile.type}</p><h3>{profile.title}</h3><p>{profile.text}</p><span className="team-profile-status">Engagement role</span></article>)}</div></MotionReveal></section><section className="ink-cta-section"><div className="site-width ink-cta-grid"><div><p className="eyebrow eyebrow-light"><span />Build with us</p><h2>Bring expertise to the work that matters.</h2></div><p>Explore career opportunities or begin a conversation with the EMFOI team.</p><Link href="/careers" className="button button-light">Explore careers <ArrowRight size={16} /></Link></div></section></PageLayout>;
}

function WhyUsPage() {
  const reasons = [
    { number: "01", title: "Client-oriented", text: "We begin with the people, workflow, and operating context behind the request, not a generic package of services." },
    { number: "02", title: "Independent", text: "We can help clarify the need and shape a practical path without forcing the work toward a predetermined platform." },
    { number: "03", title: "Competent", text: "Our delivery model brings software, AI governance, IT consulting, staffing, and healthcare context into one conversation." },
    { number: "04", title: "Results-driven", text: "We keep the engagement pointed toward a useful next step, a clearer system, or a stronger delivery position." },
    { number: "05", title: "Problem-solving", text: "We make the condition around the work visible so the response addresses the real constraint rather than only its symptom." },
    { number: "06", title: "Transparent", text: "We are clear about scope, ownership, assumptions, and what is known before the work moves forward." },
  ];
  const model = [
    { number: "01", title: "People", text: "Put the users, operators, program stakeholders, and delivery team in view." },
    { number: "02", title: "Purpose", text: "Connect technology decisions to the mission, product, or operational outcome they need to support." },
    { number: "03", title: "Process", text: "Create a practical rhythm for discovery, delivery, communication, and accountable handoff." },
  ];
  return <PageLayout><PageHero variant="record" eyebrow="Why EMFOI" title="A partner that stays close to the work." intro="EMFOI combines personal service with practical technology capability, bringing the right people and operating context into the delivery conversation." /><section className="paper-section why-us-section"><div className="site-width"><div className="why-us-intro"><div><p className="eyebrow"><span />Why us</p><h2>Personal enough to listen. Capable enough to contribute.</h2></div><p>Organizations choose a technology partner for more than a list of services. They need clear communication, thoughtful problem-solving, and a delivery posture that respects the work already underway.</p></div><div className="why-us-grid">{reasons.map((reason) => <article key={reason.number}><span>{reason.number}</span><h3>{reason.title}</h3><p>{reason.text}</p></article>)}</div></div></section><section className="site-width people-purpose-section"><div className="people-purpose-heading"><div><p className="eyebrow"><span />How we work</p><h2>People, purpose, and process.</h2></div><p>A simple framework for keeping technical decisions connected to the people and outcomes around them.</p></div><div className="people-purpose-grid">{model.map((item) => <article key={item.number}><span>{item.number}</span><h3>{item.title}</h3><p>{item.text}</p></article>)}</div></section><section className="ink-cta-section"><div className="site-width ink-cta-grid"><div><p className="eyebrow eyebrow-light"><span />Start a conversation</p><h2>See whether the fit is right.</h2></div><p>Share the work in front of you and we will start with the context, capability, and next step that make sense.</p><Link href="/contact" className="button button-light">Contact EMFOI <ArrowRight size={16} /></Link></div></section></PageLayout>;
}

function TermsConditionsPage() {
  return <PageLayout><PageHero variant="statement" eyebrow="Terms & Conditions" title="Clear information for using this website." intro="EMFOI’s current Terms & Conditions are available at the official company website. Please review the current source before relying on website-use or legal information." ><a className="button button-primary" href="https://www.emfoi.com/terms-conditions/" target="_blank" rel="noreferrer">Open current Terms &amp; Conditions <ExternalLink size={16} /></a></PageHero><section className="site-width legal-reference-section"><div className="legal-reference-card"><ShieldCheck size={28} /><div><p className="eyebrow"><span />Legal reference</p><h2>Use the current source for the current language.</h2><p>The legacy page is maintained by EMFOI at <a href="https://www.emfoi.com/terms-conditions/" target="_blank" rel="noreferrer">emfoi.com/terms-conditions</a>. This redesign preserves the route and makes the source easy to reach without presenting unverified boilerplate as a newly approved EMFOI agreement.</p><p>For privacy questions or requests related to this website, contact <a href="mailto:info@emfoi.com">info@emfoi.com</a>. You can also review the redesign’s <Link href="/privacy">Privacy Notice</Link> and manage optional analytics preferences from the footer.</p></div></div></section></PageLayout>;
}

function DoFilingPage() {
  return <PageLayout><PageHero eyebrow="DoFiling by EMFOI" title="Product engineering, applied to a legal workflow." intro="DoFiling is EMFOI’s immigration case-management platform — a cloud workspace designed to streamline case workflows, questionnaires, and document handling for attorneys and employers." ><a href="https://dofiling.com" target="_blank" rel="noreferrer" className="button button-primary">Visit DoFiling <ExternalLink size={16} /></a></PageHero><section className="dofiling-product-section"><div className="site-width product-grid"><div className="dofiling-page-logo-panel"><img src="/manus-storage/dofiling-logo-approved_9637c5b5.png" alt="Do Filing" /></div><div><p className="eyebrow"><span />What it supports</p><h2>A more organized path through casework.</h2><div className="product-feature-list"><p><Check size={18} />Structured case workflows</p><p><Check size={18} />Questionnaire coordination</p><p><Check size={18} />Document handling</p><p><Check size={18} />Collaboration for attorneys and employers</p></div><p>DoFiling is real proof of EMFOI’s product-engineering capability: a focused software experience built for a workflow with serious complexity and real users.</p></div></div></section><section className="site-width product-link-card"><div><p className="eyebrow"><span />Discover the product</p><h2>See what DoFiling can do.</h2></div><a href="https://dofiling.com" target="_blank" rel="noreferrer" className="button button-primary">Open dofiling.com <ExternalLink size={16} /></a></section></PageLayout>;
}

function CareHighPage() {
  return <PageLayout><PageHero variant="product" eyebrow="CareHigh by EMFOI" title="A clearer path for dental referrals." intro="CareHigh is software for modern dental practices that helps teams track and follow up on referrals, bringing greater visibility to an important practice workflow." ><a href="https://www.carehigh.com/" target="_blank" rel="noreferrer" className="button button-primary" onClick={() => analyticsEvent("carehigh_visit", { source: "product_page" })}>Visit CareHigh <ExternalLink size={16} /></a></PageHero><section className="carehigh-product-section"><MotionReveal className="site-width carehigh-product-grid"><div className="carehigh-page-logo"><img src="/manus-storage/carehigh-logo_381d8353.svg" alt="CareHigh" /><span>EMFOI PRODUCT PORTFOLIO</span></div><div><p className="eyebrow"><span />The workflow</p><h2>Keep the next step visible.</h2><p className="large-copy">CareHigh gives modern dental practices a focused way to track referrals and support follow-up, helping teams stay connected around patient care and practice operations.</p><div className="carehigh-feature-grid"><article><span>01</span><h3>Referral visibility</h3><p>Bring referral activity into a clearer, more trackable workflow.</p></article><article><span>02</span><h3>Follow-up support</h3><p>Help teams focus on the next action after a referral is made.</p></article><article><span>03</span><h3>Practice context</h3><p>Built around the needs of modern dental practice teams.</p></article></div></div></MotionReveal></section><section className="site-width product-link-card carehigh-link-card"><div><p className="eyebrow"><span />Learn more</p><h2>Explore CareHigh directly.</h2></div><a href="https://www.carehigh.com/" target="_blank" rel="noreferrer" className="button button-dark" onClick={() => analyticsEvent("carehigh_visit", { source: "product_cta" })}>Open carehigh.com <ExternalLink size={16} /></a></section></PageLayout>;
}

function PrivacyPage() {
  return <PageLayout><PageHero variant="statement" eyebrow="Privacy Notice" title="Clear choices, minimal tracking." intro="EMFOI uses the information you provide through this website to respond to your inquiry. Optional analytics does not load until you choose to allow it through the privacy controls." ><button className="button button-primary" onClick={() => window.dispatchEvent(new Event("emfoi:open-cookie-preferences"))}>Manage cookie preferences</button></PageHero><section className="site-width privacy-section"><MotionReveal><div className="privacy-ledger"><span>01</span><div><h2>Inquiry information</h2><p>When you use the contact form, the site prepares an email in your own email client. Any name, organization, contact details, and message you choose to send are used by EMFOI to respond to the request.</p></div></div><div className="privacy-ledger"><span>02</span><div><h2>Cookie preference storage</h2><p>The site stores your privacy preference in your browser so it can remember whether optional analytics may load. This necessary local storage does not identify you to EMFOI.</p></div></div><div className="privacy-ledger"><span>03</span><div><h2>Optional analytics</h2><p>If you allow analytics, the site loads the configured measurement service to understand aggregate page and interaction use. You may withdraw that permission at any time through the Manage cookies control in the footer.</p></div></div><div className="privacy-ledger"><span>04</span><div><h2>Contact</h2><p>For a privacy-related request, contact <a href="mailto:info@emfoi.com">info@emfoi.com</a>.</p></div></div></MotionReveal></section></PageLayout>;
}
...
function CareersPage() {
  return <PageLayout><PageHero eyebrow="Careers" title="Work on technology and staffing programs that serve real needs." intro="EMFOI is building a team of thoughtful problem-solvers across technology, consulting, and healthcare staffing. Verified, active roles will be listed here as they become available." /><section className="site-width careers-card"><BriefcaseBusiness size={30} /><h2>Open roles will appear here.</h2><p>For general interest or partnering inquiries, contact the EMFOI team and share the work you are interested in.</p><a className="button button-primary" href="mailto:info@emfoi.com?subject=Career%20interest">Email EMFOI <ArrowRight size={16} /></a></section></PageLayout>;
}

function ContactPage() {
  const officeAddress = "205 Van Buren Street, Suite 120, Herndon, VA 20170";
  const mapQuery = encodeURIComponent(officeAddress);
  return <PageLayout><PageHero variant="contact" eyebrow="Contact" title="Start with the work in front of you." intro="Whether you are exploring a capability, staffing need, partnership, or public-sector teaming opportunity, EMFOI is ready to learn more." /><section className="contact-page-section"><div className="site-width contact-page-grid"><div className="contact-details"><p className="eyebrow"><span />EMFOI headquarters</p><h2>Herndon, Virginia</h2><address><MapPin size={18} />205 Van Buren Street, Suite 120<br />Herndon, VA 20170</address><a href="mailto:info@emfoi.com">info@emfoi.com</a><a href="tel:+18003568933">1-800-356-8933</a><div className="contact-map-shell"><img className="contact-office-map" src="/asset-backup/emfoi-herndon-location-map.png" alt="Map locating EMFOI, Inc. headquarters in Herndon, Virginia" loading="lazy" /></div><a className="contact-map-attribution" href="https://www.openstreetmap.org/copyright" target="_blank" rel="noreferrer">© OpenStreetMap contributors</a><a className="contact-map-link" href={`https://www.google.com/maps/search/?api=1&query=${mapQuery}`} target="_blank" rel="noreferrer">Open directions <ExternalLink size={14} /></a><div className="contact-route"><span>01</span><p>Share the context.</p><span>02</span><p>Choose the right capability.</p><span>03</span><p>Plan a focused next step.</p></div><div className="teaming-note"><UsersRound size={20} /><p><b>For prime contractors / teaming</b><br />Choose “Government / Teaming” in the form and include the program or opportunity you are exploring.</p></div></div><div className="contact-form-panel"><h2>Tell us where you need support.</h2><ContactForm /></div></div></section></PageLayout>;
}
...
export default function InfoPage() {
  ...
  const content = location === "/government" ? <GovernmentPage />
    ...
    : location === "/contact" ? <ContactPage />
    : location === "/privacy" ? <PrivacyPage />
    : <InsightsPage />;
  return <><PageSEO {...seo} />{content}</>;
}
